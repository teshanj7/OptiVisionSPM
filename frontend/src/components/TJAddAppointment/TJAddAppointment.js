...
function CreateAppointment() {
  ...
  useEffect(() => {
    axios
      .get(`http://localhost:8040/user/get/${id}`)
      .then((res) => {
  ...
  function sendData(e) {
    ...
    axios
      .post("http://localhost:8040/Appointment/add", newAppointment)
      .then(() => {
    ...
    <div className="TJAddAppointmentPage">
      ...
      <div className="TJAddAppointmentForm">
        <form onSubmit={sendData}>
          <label htmlFor="subject" className="TJCreateFormHeading">
            Patient Full Name:{" "}
          </label>
          <br />
          <input
            type="text"
            className="TJCreateFormInput"
            id="TJAddName"
          ...
          <input
            ...
            className="TJCreateFormInput"
            id="TJAddTeleNo"
            placeholder="Enter your telephone no here"
            onChange={(e) => {
          ...
          <br />
          <textarea
            className="TJCreateTextArea"
            placeholder="Enter Transaction message here"
            rows={4}
            cols={40}
            onChange={(e) => {
          ...
          <input
            ...
            id="TJAddDoc"
            value={docName}
            placeholder="Enter the name of the transaction recorder here"
            required
            readOnly
            onChange={(e) => {
          ...
          <br />
          <br />
          <label htmlFor="date" className="TJCreateFormHeading">
            {" "}
            Appointment Date:{" "}
          </label>
          <br />
          ...
          <br />
          <br />
          <button type="submit" className="TJCreateSubmit">
            Submit
          </button>
          &nbsp;&nbsp;&nbsp;
          <button
            className="TJButtonCancel"
            onClick={(e) => {
              e.preventDefault();
              window.location.href = `/viewAllAppointments`;
            }}
